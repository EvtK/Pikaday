...
function factory() {
     ...
     */
    var hasEventListeners = !!window.addEventListener, document = window.document, sto = window.setTimeout, addEvent = function (el, e, callback, capture) {
    ...
    renderDayName = function (opts, day, abbr) {
        ...
        var date = new Date(y, m, d), week = isoWeek(date, firstWeekOfYearMinDays);
